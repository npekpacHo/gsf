...
![Version](https://img.shields.io/badge/version-1.86.1-blue)
...
<img width="1672" height="941" alt="gsf" src="https://github.com/user-attachments/assets/ba4768a5-5c08-4c7f-b5c2-793e4e7a9106" />
...
## Иконки кэшируются! 
•	успешный источник на 30 дней; 
•	отсутствие иконки на 7 дней; 
•	ошибка сети на 1 день; 

Кэш можно очистить прямо в консоли Gmail  (F12):
```text
GSF.clearIconCache()
```
